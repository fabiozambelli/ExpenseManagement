 ...
 *
 */
public class ConvertContrast2Level60Command extends CommandConfig implements Command {

	private ImageFile imageFile;
	
	public static final String ID = "CONVERT_CONTRAST_2_LEVEL_60"; 
	public static final String COMMAND = "convert " + DIR_TMP + "$.tif -contrast -contrast -level 0%x60% " + DIR_TMP + "$.tif"; 
	
	public ConvertContrast2Level60Command (ImageFile imageFile) {
