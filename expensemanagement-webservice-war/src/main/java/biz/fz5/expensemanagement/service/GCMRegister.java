...
import biz.fz5.expensemanagement.model.business.UserDeviceInterface;
import biz.fz5.expensemanagement.model.business.UserDeviceManager;
...
public class GCMRegister extends BaseServlet {
	
	protected static final Logger log = Logger.getLogger(GCMRegister.class
			.getName());
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    log.debug("GCMRegister.regId:"+regId);
    
    UserDeviceInterface userDeviceManager = new UserDeviceManager();
    try {
		userDeviceManager.create(null, regId);
	} catch (Exception e) {
